...
<!-- Снять после первого запуска бота со своим токеном:
     /status и ответ оркестра в чате → положить сюда screenshots/02-telegram.png -->
> 📷 _Скриншот чата с ботом — добавляется после запуска со своим токеном (см. ниже)._
